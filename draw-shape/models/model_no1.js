 ...
 class Model_No1 {
    constructor(data = null) {
        ...
        this.group.add(this.rect1);
        this.group.add(this.rect2);
        this.group.add(this.rect3);
        
        this.group.add(this.rect1Text);
        this.group.add(this.rect2Text);
        this.group.add(this.rect3Text);
        this.selected = "";
    }
    ...
    withStroke(val = true) {
        if (val) {
            this.rect1.strokeWidth(2);
            this.rect2.strokeWidth(2);
            this.rect3.strokeWidth(2);
        }
        else {
            this.rect1.strokeWidth(0);
            this.rect2.strokeWidth(0);
